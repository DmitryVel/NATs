...
3) Run the script and put "filter" when asked for mode. Choose your GTF file. The script will filter and sort the GTF file and will save it with the "_filtered" suffix.
